...
import static com.hytown.util.ChunkUtil.CHUNK_SIZE;
...
public class ChunkVisualizerGui extends InteractiveCustomUIPage<ChunkVisualizerGui.GuiData> {
    ...
    public void build(@Nonnull Ref<EntityStore> ref, @Nonnull UICommandBuilder uiCommandBuilder,
        ...
        uiCommandBuilder.append("Pages/hycrown_HyTown_ChunkVisualizer.ui");
        ...
        for (int z = 0; z <= gridSize * 2; z++) {
            ...
            for (int x = 0; x <= gridSize * 2; x++) {
                uiCommandBuilder.append("#ChunkCards[" + z + "]", "Pages/hycrown_HyTown_ChunkEntry.ui");
