...
public class TownyHelpPage extends BasicCustomUIPage {
    ...
    public TownyHelpPage(HyTown plugin, PlayerRef playerRef) {
     ...
     */
    public static void openFor(HyTown plugin, Player player, Ref<EntityStore> ref, Store<EntityStore> store) {
     ...
     */
    public static void openFor(HyTown plugin, Player player) {
        try {
