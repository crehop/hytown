...
import com.hytowny.gui.TownGui;
import com.hytowny.gui.TownHelpGui;
...
public class TownCommand extends AbstractPlayerCommand {
    ...
    public TownCommand(HyTowny plugin) {
    ...
    private void showHelp(PlayerRef playerData, boolean isAdmin) {
        ...
        playerData.sendMessage(Message.raw("/town set board <msg> - Set town message").color(WHITE));
